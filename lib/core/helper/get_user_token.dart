...
class GetUserToken {
  ...
  static Future<String>? getToken() async{
    return await AppSecureStorageHelper
        .getToken(SharedPrefKeys.token);
  }
}
...
class GetUserData {
  static String? getPofileImage() {
    return SharedPreferencesHelper
        .getString(SharedPrefKeys.profileImage);
  }

  static String? getUserName() {
    return SharedPreferencesHelper
        .getString(SharedPrefKeys.userName);
  }
   static String? getUserPhone() {
    return SharedPreferencesHelper
        .getString(SharedPrefKeys.userphone);
  }
...
class WelcomeScreenOpend {
  static bool getWelcomeScreenOpend() {
    return SharedPreferencesHelper
                .getString(SharedPrefKeys.onBoarding) ==
            "done"
        ? true
        : false;
  }
